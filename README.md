...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j-bf9do.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j-bf9do.containers.anotherwebservice.com/
...
```
git clone git@github.com:roboticmc/container-j-bf9do.git
cd container-j-bf9do
```
...
```
docker attach container-j-bf9do
```
